            ...
            <ul>
              <li class="mb-4">
                <label for="featured" class="flex items-center dark:text-gray-300">
                  ...
                  <span class="text-lg dark:text-gray-400">Fetured Products</span>
                </label>
              </li>
              <li class="mb-4">
...
<img src="{{ !empty($product->images) ? url('storage/' . $product->images[0]) : 'https://placehold.co/600x400' }}" alt="{{ $product->name }}" class="object-cover w-full h-56 mx-auto">                  </a>
                </div>
                <div class="p-3 ">
                ...
                <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">
                   ...
                   <a wire:click.prevent='addToCart({{ $product->id }})' href="#" class="flex items-center space-x-2 text-gray-500 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-300"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="w-4 h-4 bi bi-cart3 " viewBox="0 0 16 16">
